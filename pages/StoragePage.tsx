...
const assets = {
  ...
  heroBg: '/gentrack-portal/assets/oxygen/storage/hero_bg.png',
  contentImg: '/gentrack-portal/assets/oxygen/storage/content_img.png', // Leaving for potential re-use
  batteryImg: '/gentrack-portal/assets/oxygen/storage/battery_img.png',
  hydroImg: '/gentrack-portal/assets/oxygen/storage/hydro_img.png',
  customerStoryImg: '/gentrack-portal/assets/oxygen/storage/customer_story_bg.png',
  // fullWidthDisplay: '/gentrack-portal/assets/oxygen/storage/full_width_storage.png', // Replaced
  wideSectionBg: '/gentrack-portal/assets/oxygen/storage/wide_section_bg.png', // New background
  circularFeature: '/gentrack-portal/assets/oxygen/storage/circular_feature.png', // New circular image
  storageFeature: '/gentrack-portal/assets/oxygen/storage/storage_feature.png',
  grid1: '/gentrack-portal/assets/oxygen/grid_img_1.png',
  maskGraphic: '/gentrack-portal/assets/oxygen/mask_graphic.svg',
  maskGraphicLayer2: '/gentrack-portal/assets/oxygen/mask_graphic_layer2.svg',
  customerStoryReplacement: '/gentrack-portal/assets/oxygen/storage/customer_story_replacement.svg',
  // Footer Assets
