...
export const Stripe: React.FC = () => {
  ...
  useEffect(() => {
    ...
    function init() {
      ...
      // Optional: Click to randomize
      // canvasRef.current.addEventListener('click', initRandomScene);
    ...
    function updateSize() {
      ...
      // Adjust camera aspect or scale if needed, but the shader uses normalized coordinates
    }
  ...
  return (
    <div ref={containerRef} className="w-full h-32 md:h-48 relative overflow-hidden bg-surface/30">
